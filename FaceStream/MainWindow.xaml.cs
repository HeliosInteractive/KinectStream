...
namespace Microsoft.Samples.Kinect.FaceBasics
{
    ...
    public class KinectSocketMessage
    {
        public string type;
        public Object data;
    }
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        WebSocket ws = new WebSocket("ws://localhost:4567");
        ...
        {   
            ...
            // TODO: make this its own thang
            JSONClass message = new JSONClass();
            message["type"] = "face";
            message["data"] = new JSONClass();
            ...
            if (faceResult.FacePointsInColorSpace != null)
            {
                ...
                foreach (PointF pointF in faceResult.FacePointsInColorSpace.Values)
                {
                    ...
                    JSONClass point = new JSONClass();
                    point["x"] = pointF.X.ToString();
                    point["y"] = pointF.Y.ToString();
                    message["data"]["points"].Add(point);
                }
            }
            ...
            if (faceResult.FaceProperties != null)
            {
                ...
                {
                    faceText += item.Key.ToString() + " : " + item.Value.ToString() + "\n";
                    message["data"]["properties"][item.Key.ToString()] = item.Value.ToString();
                }
            }
            ...
            if (faceResult.FaceRotationQuaternion != null)
            {
                ...
                message["data"]["orientation"]["yaw"] = yaw.ToString();
                message["data"]["orientation"]["pitch"] = pitch.ToString();
                message["data"]["orientation"]["roll"] = roll.ToString();
            }
